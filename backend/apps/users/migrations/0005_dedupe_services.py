...
def forwards(apps, schema_editor):
    ...
    for services_group in grouped.values():
        ...
        duplicates = [service for service in services_group if service.id_service != canonical.id_service]
        duplicate_ids = [service.id_service for service in duplicates]
...
def backwards(apps, schema_editor):
    # Dedupe is destructive; keep canonical services as is on reverse.
    pass


class Migration(migrations.Migration):
    dependencies = [
        ("users", "0004_polish_service_labels"),
